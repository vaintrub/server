                           ...
                           const char *filename)
{
  ...
  {
    /*
     Do not warn on password, it maybe treated as binary value
     rather than string. It is rather weird, but if people
     used non-UTF8, and then change that to UTF8, they will lose
     connectivity.
    */
    return;
  }
